---
description: >-
  Notes and resources for building Stab Tips on weapons with omnidirectional
  striking surfaces.
---
...
To finish the stab tip foundation, use an end cap that matches the blade profile, made from the same foam as the donut around the biscuit. This only needs to be 1/2" thick.  Apply carpet tape to one of the faces of this end cap.
